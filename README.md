...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/zocalo-dls-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7284&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/zocalo-dls-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `zocalo-dls` can be installed with:

```
conda install zocalo-dls
```

It is possible to list all of the versions of `zocalo-dls` available on your platform with:
